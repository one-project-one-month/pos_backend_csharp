using DotNet8.PosFrontendBlazor.Server.Models.Dashboard;
using DotNet8.PosFrontendBlazor.Server.Services;

namespace DotNet8.PosFrontendBlazor.Server.Pages.Dashboard
{
    public partial class P_Dashboard
    {
        ...
        protected override async Task OnAfterRenderAsync(bool firstRender)
        {
            if (firstRender)
            {
                ...
                await Microsoft.JSInterop.JSRuntime.InvokeVoidAsync("setLineColumnChart", response);
                await Microsoft.JSInterop.JSRuntime.InvokeVoidAsync("setFunnelChart", dailyResponse);
